...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit aggiungi_materie based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-aggiungi_materie at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-aggiungi_materie at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to aggiungi_materie.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
